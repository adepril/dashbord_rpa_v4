                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-3">
                            <Input
                                ...
                                required
                                className="max-w-sm mx-auto px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                            />
                            <Input
                                id="password"
                                type="password"
